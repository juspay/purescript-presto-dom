...
prepareScreen :: forall action state retType. Screen action state retType -> Flow Unit
prepareScreen screen = doAff do makeAff \cb -> PrestoDOM.prepareScreen screen cb
